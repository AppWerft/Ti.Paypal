...
inline unsigned int
PaypalBindings::hash (register const char *str, register unsigned int len)
{
  ...
  return len + asso_values[(unsigned char)str[13]];
}

struct titanium::bindings::BindEntry *
PaypalBindings::lookupGeneratedInit (register const char *str, register unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 2,
